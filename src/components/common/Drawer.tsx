        ...
        <div className="fixed inset-0 z-50 overflow-hidden">
          ...
          <div className="p-4 border-b border-[#262626] flex items-center justify-between bg-[#121212]">
            <div className="flex items-center gap-2">
              <span className="text-lg font-black text-white font-sans">
                SMM<span className="text-[#0088CC]">X</span>MEDIA
              </span>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="p-4 border-b border-[#262626] bg-[#141414] space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                >
                  <img
                    src={user.avatar}
                    alt={user.name}
                    className="w-14 h-14 rounded-full object-cover border-2 border-[#0088CC] shadow-md"
                  />
                ...
                <div className="overflow-hidden">
                  ...
                  <button
                    ...
                    className="text-[11px] text-[#0088CC] hover:underline block font-semibold"
                  >
              ...
              <button
                ...
                className="p-2 rounded-xl bg-[#1a1a1a] border border-[#262626] text-gray-300 hover:text-white hover:border-[#0088CC]/50 transition-all"
            ...
            <div className="p-3 rounded-xl bg-[#1a1a1a] border border-[#262626] flex items-center justify-between">
              <div>
                ...
                <span className="text-lg font-black text-[#0088CC] font-sans">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-[#0088CC] hover:bg-[#006699] text-white text-xs font-bold flex items-center gap-1 shadow-md transition-colors"
              >
          ...
          <div className="p-3 space-y-1.5 flex-1 text-xs sm:text-sm font-medium">
            ...
            <button
              ...
              className="w-full py-3 px-3.5 rounded-xl bg-[#0088CC] hover:bg-[#006699] text-white font-bold text-xs flex items-center justify-between shadow-lg red-glow transition-all"
            >
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl transition-colors ${
                activeTab === 'services'
                  ? 'bg-[#0088CC]/10 text-[#0088CC] font-bold border border-[#0088CC]/30'
            ...
            >
              <span className="flex items-center gap-3">
                <LayoutGrid className="w-4 h-4 text-[#0088CC]" />
            ...
            >
              <span className="flex items-center gap-3">
                <Handshake className="w-4 h-4 text-[#0088CC]" />
          ...
          <div className="p-4 border-t border-[#262626] bg-[#141414] space-y-3">
            ...
            <button
              ...
              className="w-full py-2.5 px-4 rounded-xl border border-[#0088CC]/50 text-red-400 hover:bg-red-500/10 hover:text-red-300 font-bold text-xs flex items-center justify-center gap-2 transition-colors"
            >
