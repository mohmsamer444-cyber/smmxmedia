    ...
    <div className="bg-[#141414] border border-[#262626] hover-red-glow rounded-2xl p-4 flex flex-col justify-between shadow-xl text-right transition-all group">
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <span className="text-[10px] font-bold text-[#0088CC] bg-[#0088CC]/10 border border-[#0088CC]/30 px-2.5 py-0.5 rounded-full">
            ID: #{service.id}
          </span>
        ...
        <h4 className="font-bold text-xs sm:text-sm text-white group-hover:text-[#0088CC] transition-colors leading-relaxed">
          {service.name}
        </h4>
      ...
      <div className="pt-3 mt-3 border-t border-[#262626] flex items-center justify-between">
        <div>
          ...
          <span className="text-sm font-black text-[#0088CC] font-sans">
        ...
        <button
          ...
          className="px-3.5 py-2 rounded-xl bg-[#0088CC] hover:bg-[#006699] text-white text-xs font-bold flex items-center gap-1.5 shadow-md red-glow transition-all"
        >
