...
const PLATFORMS: PlatformConfig[] = [
  {
    ...
    name: 'تيك توك',
    icon: FaTiktok,
    containerClass: 'bg-black border-2 border-[#0088CC] text-white red-glow',
    ...
    particleColors: ['text-red-500', 'text-pink-400', 'text-[#0088CC]', 'text-cyan-400'],
  },
  {
    id: 'youtube',
    name: 'يوتيوب',
      ...
      <AnimatePresence>
        {showBadge && (
          <motion.div
            ...
            className="absolute -top-6 left-1/2 -translate-x-1/2 z-30 pointer-events-none px-2 py-0.5 rounded-full bg-black/90 border border-[#0088CC]/60 text-[#0088CC] font-black text-[10px] tracking-wider font-mono shadow-[0_0_12px_rgba(227,30,36,0.6)] whitespace-nowrap"
          >
...
export const PlatformIconCluster: React.FC = () => {
  return (
    <div className="relative w-64 h-52 sm:w-72 sm:h-56 shrink-0 flex items-center justify-center select-none">
      ...
      <div className="absolute bottom-2 w-48 h-12 rounded-full border-2 border-[#0088CC]/60 bg-[#0088CC]/10 blur-[1px] shadow-[0_0_20px_rgba(227,30,36,0.6)] transform rotate-x-60 animate-pulse-glow" />
