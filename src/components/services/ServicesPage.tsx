  ...
  return (
    <div className="space-y-6 pb-20 text-right w-full max-w-full overflow-x-hidden">
      ...
      <div className="relative bg-[#111111] border border-[#262626] rounded-3xl p-6 sm:p-8 overflow-hidden shadow-2xl min-h-[260px]">
        {/* Glow Radial Stage */}
        <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-80 h-80 bg-[#0088CC]/20 blur-[90px] rounded-full pointer-events-none animate-pulse-glow" />
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 relative z-10">
          ...
          <div className="space-y-3 text-right max-w-xl animate-slide-up">
            ...
            <button
              ...
              className="mt-2 px-6 py-2.5 rounded-xl bg-[#0088CC] hover:bg-[#006699] text-white font-bold text-xs shadow-lg red-glow transition-all inline-flex items-center gap-2"
            >
      ...
      <div className="relative">
        <input
          ...
          className="w-full bg-[#141414] border border-[#262626] focus:border-[#0088CC] rounded-2xl pl-4 pr-11 py-3 text-xs sm:text-sm text-white placeholder-gray-500 focus:outline-none shadow-xl transition-all"
        />
            ...
            >
              <div
                className={`w-13 h-13 sm:w-14 sm:h-14 rounded-full flex items-center justify-center transition-all duration-300 border-2 ${
                  isActive
                    ? 'border-[#0088CC] bg-[#1a1a1a] text-white shadow-[0_0_15px_rgba(227,30,36,0.6)] scale-105'
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="p-3 bg-[#141414] border border-[#262626] rounded-2xl flex items-center gap-2.5">
          <div className="p-2 bg-[#0088CC]/10 text-[#0088CC] rounded-xl shrink-0">
      ...
      <div className="space-y-4 pt-4 border-t border-[#262626]">
        <div className="flex items-center justify-between">
          <h3 className="font-extrabold text-base text-white flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-[#0088CC] font-sans">
      ...
      <div className="p-6 bg-[#141414] border border-[#262626] rounded-3xl space-y-4 text-center">
        <h4 className="font-extrabold text-sm text-white flex items-center justify-center gap-1.5">
          <Grid className="w-4 h-4 text-[#0088CC]" />
          ...
          {extraPlatforms.map(p => {
            ...
            return (
              <button
                ...
                className="px-3.5 py-2 rounded-xl bg-[#0A0A0A] border border-[#262626] hover:border-[#0088CC] text-xs font-bold text-gray-300 flex items-center gap-2 transition-all hover:scale-105"
              >
        ...
        <button
          ...
          className="w-full py-3 rounded-2xl bg-[#0088CC] hover:bg-[#006699] text-white font-bold text-xs shadow-lg red-glow transition-all flex items-center justify-center gap-2 mt-4"
        >
          <span>عرض جميع الخدمات</span>
          <ArrowLeft className="w-4 h-4" />
        </button>
