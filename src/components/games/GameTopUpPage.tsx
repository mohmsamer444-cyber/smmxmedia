  ...
  return (
    <div className="space-y-6 pb-20 text-right w-full max-w-full overflow-x-hidden">
      ...
      <div className="relative bg-[#0d0d0d] border border-[#262626] rounded-3xl p-6 sm:p-8 overflow-hidden shadow-2xl min-h-[300px]">
        ...
        <div className="absolute -bottom-20 right-1/4 w-96 h-96 bg-[#0088CC]/25 blur-[100px] rounded-full pointer-events-none animate-pulse-glow z-0" />
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
          {emberParticles.map((pt, idx) => (
            <div
              key={idx}
              className="absolute w-1.5 h-1.5 bg-gradient-to-t from-amber-500 to-[#0088CC] rounded-full blur-[0.5px] animate-ember"
              style={{
                left: pt.left,
                bottom: '-10px',
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="space-y-3 text-right max-w-xl animate-slide-up">
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs font-bold pt-2">
              <span className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#0088CC]/15 text-[#0088CC] border border-[#0088CC]/40 shadow-sm backdrop-blur-sm">
                ⚡ تسليم فوري
              </span>
          ...
          <div className="flex items-center justify-center -space-x-3 sm:-space-x-5 space-x-reverse pt-2 lg:pt-0 z-10">
            ...
            <div
              ...
              className={`relative w-28 sm:w-32 lg:w-36 h-40 sm:h-48 rounded-2xl overflow-hidden border-2 cursor-pointer transition-all duration-500 transform ${
                gameFilter === 'pubg'
                  ? 'border-[#0088CC] scale-110 z-30 opacity-100 shadow-[0_0_25px_rgba(227,30,36,0.7)] animate-bob-1'
            ...
            >
              ...
              <div className="absolute bottom-2 inset-x-0 text-center p-1 z-10 flex flex-col items-center">
                ...
                <span className="text-[9px] text-[#0088CC] font-bold block">MOBILE</span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-3 sm:grid-cols-5 gap-2 bg-[#141414] border border-[#262626] p-2 rounded-2xl shadow-xl">
        <button
          ...
          className={`py-3 px-4 rounded-xl font-black text-xs sm:text-sm flex items-center justify-center gap-2 transition-all ${
            gameFilter === 'pubg'
              ? 'bg-[#0088CC] text-white shadow-lg red-glow'
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div className="p-4 bg-[#141414] border border-[#262626] rounded-2xl flex items-center justify-between shadow-xl">
          ...
          <button
            ...
            className="p-2 rounded-xl bg-[#0088CC] hover:bg-[#006699] text-white font-bold text-xs flex items-center gap-1 shadow-md red-glow"
          >
        ...
        <button
          ...
          className="p-4 bg-[#141414] border border-[#262626] hover:border-[#0088CC] rounded-2xl flex items-center justify-between shadow-xl transition-colors group"
        >
          <div className="flex items-center gap-3">
            <div className="p-2.5 rounded-xl bg-blue-500/10 text-blue-400 group-hover:bg-[#0088CC] group-hover:text-white transition-colors">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-extrabold text-base text-white flex items-center gap-2">
              <Flame className="w-5 h-5 text-[#0088CC]" />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {pubgPackages.map(pkg => (
              ...
              >
                {pkg.discountBadge && (
                  <span className="absolute top-2 right-2 bg-[#0088CC] text-white text-[10px] font-black px-2 py-0.5 rounded-md shadow-md">
                    {pkg.discountBadge}
                  </span>
                )}
                ...
                <div className="space-y-2 pt-2">
                  ...
                  <span className="text-sm font-black text-[#0088CC] block font-sans">
                ...
                <button
                  ...
                  className="w-full py-2 rounded-xl bg-[#0088CC] hover:bg-[#006699] text-white font-bold text-xs shadow-md red-glow transition-all flex items-center justify-center gap-1"
                >
