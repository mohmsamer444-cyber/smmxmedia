      ...
      <div className="bg-[#141414] border border-[#262626] rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-2xl">
        <div className="space-y-1">
          <h1 className="text-xl sm:text-2xl font-black text-white flex items-center gap-2">
            <ClipboardList className="w-6 h-6 text-[#0088CC]" />
        ...
        <div className="px-4 py-2 rounded-2xl bg-[#0A0A0A] border border-[#262626] flex items-center gap-2 text-xs">
          ...
          <span className="font-black text-[#0088CC] font-sans">{orders.length}</span>
        </div>
      </div>
                  ...
                  <tr key={order.id} className="hover:bg-[#1a1a1a]/60 transition-colors">
                    ...
                    <td className="p-3.5 font-bold text-white font-sans dir-ltr text-right">
                      <button
                        ...
                        className="inline-flex items-center gap-1 hover:text-[#0088CC]"
                      >
                        #{order.id}
                    ...
                    <td className="p-3.5 text-gray-400 font-sans max-w-xs truncate dir-ltr text-right">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="hover:text-[#0088CC] inline-flex items-center gap-1"
                      >
                        {order.link}
                    ...
                    {/* Cost */}
                    <td className="p-3.5 font-black text-[#0088CC] font-sans">
                    ...
                    <td className="p-3.5 text-center">
                      <button
                        ...
                        className="px-2.5 py-1 rounded-lg bg-[#262626] hover:bg-[#0088CC] text-gray-300 hover:text-white font-bold text-[11px] transition-all inline-flex items-center gap-1"
                      >
