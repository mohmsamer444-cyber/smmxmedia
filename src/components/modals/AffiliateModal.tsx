      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
        ...
        >
          ...
          <div className="p-5 space-y-5 text-right">
            {/* Banner info */}
            <div className="p-4 bg-gradient-to-r from-[#0088CC]/20 via-[#1a1a1a] to-[#0A0A0A] border border-[#0088CC]/30 rounded-2xl space-y-2">
              <div className="flex items-center gap-2 font-black text-white text-sm">
                <Award className="w-5 h-5 text-[#0088CC]" />
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-white block flex items-center gap-1.5">
                <Share2 className="w-3.5 h-3.5 text-[#0088CC]" />
