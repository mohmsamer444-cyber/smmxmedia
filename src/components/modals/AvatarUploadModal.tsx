            ...
            {!selectedImage ? (
              ...
              <div className="flex flex-col items-center space-y-5">
                <div className="relative group">
                  <img
                    src={user.avatar}
                    alt={user.name}
                    className="w-32 h-32 rounded-full object-cover border-4 border-[#0088CC] shadow-2xl ring-4 ring-[#0088CC]/20"
                  />
                  <div
                  ...
                  >
                    <Upload className="w-6 h-6 mb-1 text-[#0088CC]" />
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 w-full">
                  <button
                    onClick={() => fileInputRef.current?.click()}
                    className="w-full py-3 px-4 rounded-xl bg-[#0088CC] hover:bg-[#006699] text-white font-bold text-xs flex items-center justify-center gap-2 red-glow transition-all"
                  >
              ...
              <div className="flex flex-col items-center space-y-5">
                ...
                <div
                  ...
                  className="relative w-52 h-52 rounded-full border-4 border-[#0088CC] shadow-[0_0_25px_rgba(227,30,36,0.5)] overflow-hidden bg-black cursor-grab active:cursor-grabbing select-none"
                >
                  <img
                    ref={imgRef}
                    src={selectedImage}
                ...
                <div className="w-full bg-[#0A0A0A] p-3 rounded-xl border border-[#262626] space-y-2">
                  <div className="flex items-center justify-between text-xs text-gray-300">
                    <span className="font-bold flex items-center gap-1">
                      <ZoomIn className="w-3.5 h-3.5 text-[#0088CC]" />
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      className="w-full accent-[#0088CC] bg-[#262626] h-1.5 rounded-lg cursor-pointer"
                    />
                    <button
                ...
                <div className="flex items-center gap-3 w-full">
                  <button
                    ...
                    disabled={isSaving}
                    className="w-full py-3 px-4 rounded-xl bg-[#0088CC] hover:bg-[#006699] text-white font-bold text-xs flex items-center justify-center gap-2 red-glow transition-all disabled:opacity-60"
                  >
