          ...
          <div className="p-5 space-y-4 overflow-y-auto text-right">
            {activeSubTab === 'myKey' ? (
              <div className="space-y-4">
                {/* Explanation Banner */}
                <div className="p-3.5 bg-[#0A0A0A] border border-[#0088CC]/30 rounded-xl space-y-1.5 text-xs text-gray-300">
                  ...
                  <p className="text-[11px] text-gray-400 leading-relaxed">
                    يوفر لك متجر بلس ميديا واجهة برمجة تطبيقات (API) قياسية تتيح لك سحب جميع خدماتنا وعرضها على متجرك أو بانلك الخاص وتنفيذ الطلبات أوتوماتيكياً ورسومات أرباحك مباشرة!
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-white block flex items-center justify-between">
                    <span className="flex items-center gap-1.5">
                      <Key className="w-3.5 h-3.5 text-[#0088CC]" />
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2.5 rounded-xl bg-[#0088CC] hover:bg-[#006699] text-white text-xs font-bold flex items-center gap-1.5 transition-colors shrink-0"
                    >
              ...
              <form onSubmit={handleTestAndSaveProvider} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0A0A0A] border border-[#262626] rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-[#0088CC] dir-ltr text-left font-sans"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={isTesting}
                  className="w-full py-3 rounded-xl bg-[#0088CC] hover:bg-[#006699] text-white font-bold text-sm shadow-lg red-glow transition-all flex items-center justify-center gap-2"
                >
