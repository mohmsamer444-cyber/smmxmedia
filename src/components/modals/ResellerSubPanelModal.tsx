          ...
          <div className="p-5 space-y-5 overflow-y-auto text-right">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="p-3 bg-[#0A0A0A] border border-[#262626] rounded-xl text-center">
                ...
                <span className="text-base font-extrabold text-[#0088CC] flex items-center justify-center gap-0.5">
                  %{profitMargin}
            ...
            <div className="p-4 bg-[#1a1a1a] border border-[#262626] rounded-xl space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-bold text-[#0088CC]">{profitMargin}%</span>
              </div>
              <input
                type="range"
                min="5"
                ...
                className="w-full accent-[#0088CC] bg-[#0A0A0A] h-2 rounded-lg cursor-pointer"
              />
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-[#0088CC] hover:bg-[#006699] text-white text-xs font-bold flex items-center gap-1 transition-colors"
                >
              ...
              {isAdding && (
                <form onSubmit={handleAddClient} className="p-3 bg-[#0A0A0A] border border-[#0088CC]/40 rounded-xl space-y-2">
                  <input
                    type="text"
                    value={newClientName}
                  ...
                  <button
                    type="submit"
                    className="w-full py-2 bg-[#0088CC] text-white font-bold text-xs rounded-lg hover:bg-[#006699]"
                  >
                    حفظ العميل
                  </button>
                </form>
