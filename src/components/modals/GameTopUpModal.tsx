        ...
        >
          ...
          <div className="p-4 border-b border-[#262626] flex items-center justify-between bg-[#1a1a1a]">
            <h3 className="font-bold text-sm text-white flex items-center gap-2">
              <Gamepad2 className="w-4 h-4 text-[#0088CC]" />
              {gameTitle}
            </h3>
            <button
          ...
          <form onSubmit={handleSubmit} className="p-4 space-y-4">
            ...
            <div className="p-3.5 bg-[#0A0A0A] border border-[#262626] rounded-xl flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-[10px] text-[#0088CC] font-bold block uppercase tracking-wider">
                    الحزمة المختارة
                  </span>
              ...
              <div className="text-right">
                ...
                <span className="text-lg font-black text-[#0088CC]">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#0A0A0A] border border-[#262626] rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-[#0088CC] font-sans text-left dir-ltr"
              />
            ...
            {!isBalanceSufficient && (
              <div className="p-3 bg-red-500/10 border border-red-500/30 rounded-xl flex items-center justify-between text-xs text-red-400">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-[#0088CC] text-white font-bold text-[11px]"
                >
                  إيداع رصيد
                </button>
              </div>
