        ...
        >
          ...
          <form onSubmit={handleSubmit} className="p-4 space-y-4">
            ...
            <div className="p-3.5 bg-[#0A0A0A] border border-[#262626] rounded-xl space-y-1">
              <div className="text-[11px] text-[#0088CC] font-bold">
              ...
              <p className="text-[11px] text-gray-400 mt-1">
                السعر لكل 1000: <span className="text-[#0088CC] font-bold">{formatPrice(selectedServiceForOrder.rate)}</span> | الحد الأقل: {selectedServiceForOrder.min} - الأقصى: {selectedServiceForOrder.max.toLocaleString()}
              </p>
            </div>
            ...
            <div>
              <label className="text-xs font-bold text-white block mb-1.5 flex items-center gap-1.5">
                <LinkIcon className="w-3.5 h-3.5 text-[#0088CC]" />
              ...
              <input
                ...
                className="w-full bg-[#0A0A0A] border border-[#262626] rounded-xl px-3.5 py-2.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-[#0088CC] dir-ltr text-left"
              />
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-xs font-bold text-white flex items-center gap-1.5">
                  <Hash className="w-3.5 h-3.5 text-[#0088CC]" />
                  الكمية المطلوبة
                </label>
              ...
              <input
                ...
                className="w-full bg-[#0A0A0A] border border-[#262626] rounded-xl px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-[#0088CC] font-sans"
              />
            </div>
            ...
            <div className="p-3.5 bg-[#1a1a1a] border border-[#262626] rounded-xl flex items-center justify-between">
              ...
              <div className="text-right">
                <span className="text-lg font-black text-[#0088CC] block">
            ...
            {!isBalanceSufficient && (
              <div className="p-3 bg-red-500/10 border border-red-500/30 rounded-xl flex items-center justify-between text-xs text-red-400">
                ...
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-[#0088CC] text-white font-bold text-[11px] shrink-0"
                >
                  إيداع رصيد
                </button>
              </div>
            ...
            <button
              ...
              className={`w-full py-3 rounded-xl font-bold text-sm text-white shadow-lg transition-all flex items-center justify-center gap-2 ${
                isBalanceSufficient && !isSubmitting
                  ? 'bg-[#0088CC] hover:bg-[#006699] red-glow'
