        ...
        <div className="space-y-2">
          {conversations.map(chat => (
            <button
              ...
              className="w-full p-2 rounded-xl bg-[#0A0A0A] border border-[#262626] hover:border-[#0088CC]/50 transition-all flex items-center justify-between text-right group"
            >
              <div className="flex items-center gap-2.5 overflow-hidden">
                <div className="relative shrink-0">
                  <img
                    ...
                    alt={chat.user.name}
                    className="w-9 h-9 rounded-full object-cover border border-[#0088CC]"
                  />
                  {chat.user.isOnline && (
                ...
                <div className="overflow-hidden">
                  <div className="font-bold text-xs text-white group-hover:text-[#0088CC] truncate">
                    {chat.user.name}
                  </div>
              ...
              {chat.unreadCount > 0 && (
                <span className="px-1.5 py-0.5 bg-[#0088CC] text-white text-[10px] font-bold rounded-full shrink-0">
                  {chat.unreadCount}
                </span>
              )}
            </button>
      ...
      <div className="bg-[#141414] border border-[#262626] rounded-2xl p-4 space-y-3 shadow-xl">
        <div className="flex items-center justify-between pb-2 border-b border-[#262626]">
          ...
          <button
            ...
            className="p-1 rounded-lg bg-[#0088CC]/10 text-[#0088CC] hover:bg-[#0088CC] hover:text-white transition-colors"
        ...
        <div className="space-y-2">
          {groups.map(group => (
            <div
              ...
              className="p-2.5 rounded-xl bg-[#0A0A0A] border border-[#262626] hover:border-[#0088CC]/50 cursor-pointer transition-all flex items-center justify-between"
            >
              <div className="flex items-center gap-2.5 overflow-hidden">
                <img
                  src={group.avatar}
              ...
              {group.unreadBadge > 0 && (
                <span className="px-1.5 py-0.5 bg-[#0088CC]/20 text-[#0088CC] text-[10px] font-bold rounded-md shrink-0">
                  +{group.unreadBadge}
                </span>
              )}
            </div>
        ...
        <div className="space-y-2">
          {onlineFriends.map(friend => (
            <button
              ...
              className="w-full p-2 rounded-xl bg-[#0A0A0A] border border-[#262626] hover:border-[#0088CC]/50 transition-all flex items-center justify-between text-right"
            >
