    ...
    <div className="space-y-4 text-right">
      <div className="flex items-center justify-between bg-[#141414] border border-[#262626] p-4 rounded-2xl">
        ...
        <button
          ...
          className="px-3.5 py-2 rounded-xl bg-[#0088CC] hover:bg-[#006699] text-white font-bold text-xs flex items-center gap-1.5 shadow-lg red-glow"
        >
          ...
          >
            <div className="flex items-start gap-3">
              <img
                src={group.avatar}
                alt={group.name}
                className="w-12 h-12 rounded-2xl object-cover border-2 border-[#0088CC] shrink-0"
              />
            ...
            <div className="pt-3 border-t border-[#262626] flex items-center justify-between text-xs">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-[#1f1f1f] hover:bg-[#0088CC] hover:text-white text-gray-200 font-bold transition-all flex items-center gap-1"
              >
