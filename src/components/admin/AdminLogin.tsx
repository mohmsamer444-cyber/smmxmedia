    ...
    <div dir="rtl" className="min-h-screen w-full bg-[#0A0A0A] text-white flex items-center justify-center px-4">
      <div className="w-full max-w-sm bg-[#141414] border border-[#262626] rounded-2xl p-6 sm:p-8 shadow-2xl">
        <div className="text-center mb-6">
          <h1 className="text-xl font-extrabold text-[#0088CC]">لوحة تحكم الإدارة</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            <input
              ...
              required
              className="w-full bg-[#0A0A0A] border border-[#262626] focus:border-[#0088CC] rounded-xl py-3 pr-10 pl-3 text-sm outline-none transition-colors"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-3 rounded-xl bg-[#0088CC] hover:bg-[#c81920] disabled:opacity-60 font-bold text-sm flex items-center justify-center gap-2 transition-colors"
          >
