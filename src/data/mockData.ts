...
export const CURRENT_USER: UserProfile = {
  ...
  verified: true,
  bio: 'خبير تسويق رقمي وصانع محتوى ألعاب | وكيل معتمد لدى متجر بلس ميديا',
  followers: 14200,
  following: 380,
  balanceUSD: 125.50,
  ordersCount: 28,
...
export const GAME_PACKAGES: GamePackage[] = [
  ...
  // TikTok Coins — تحديث سبتمبر 2026، الأسعار بالجنيه المصري محوّلة لدولار بسعر صرف ~49 ج = 1$
  { id: 'tiktok-1', game: 'tiktok', amount: 500, unit: 'كوينز', priceUSD: 6.12, discountBadge: '-15%' },
  { id: 'tiktok-2', game: 'tiktok', amount: 1000, unit: 'كوينز', priceUSD: 11.12, discountBadge: '-15%' },
  { id: 'tiktok-3', game: 'tiktok', amount: 2000, unit: 'كوينز', priceUSD: 22.24, discountBadge: '-15%' },
  { id: 'tiktok-4', game: 'tiktok', amount: 3000, unit: 'كوينز', priceUSD: 33.37, discountBadge: '-15%' },
  { id: 'tiktok-5', game: 'tiktok', amount: 4000, unit: 'كوينز', priceUSD: 44.49, discountBadge: '-15%' },
  { id: 'tiktok-6', game: 'tiktok', amount: 5000, unit: 'كوينز', priceUSD: 55.61, discountBadge: '-15%' },
  { id: 'tiktok-7', game: 'tiktok', amount: 6000, unit: 'كوينز', priceUSD: 66.73, discountBadge: '-15%' },
  { id: 'tiktok-8', game: 'tiktok', amount: 7000, unit: 'كوينز', priceUSD: 77.86, discountBadge: '-15%' },
  { id: 'tiktok-9', game: 'tiktok', amount: 8000, unit: 'كوينز', priceUSD: 88.98, discountBadge: '-15%' },
  { id: 'tiktok-10', game: 'tiktok', amount: 9000, unit: 'كوينز', priceUSD: 100.10, discountBadge: '-15%' },
  { id: 'tiktok-11', game: 'tiktok', amount: 10000, unit: 'كوينز', priceUSD: 110.20, discountBadge: '-15%' },
  { id: 'tiktok-12', game: 'tiktok', amount: 30000, unit: 'كوينز', priceUSD: 302.04, discountBadge: '-15%' },
  { id: 'tiktok-13', game: 'tiktok', amount: 50000, unit: 'كوينز', priceUSD: 550.67, discountBadge: '-15%' },
  ...
  { id: 'ai-9', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.50, label: 'GitHub Copilot', discountBadge: '-15%' },
  { id: 'ai-10', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 17.00, label: 'Cursor Pro', discountBadge: '-15%' },
  { id: 'ai-11', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.50, label: 'Notion AI', discountBadge: '-15%' },
  { id: 'ai-12', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 33.15, label: 'Jasper AI', discountBadge: '-15%' },
  { id: 'ai-13', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 30.60, label: 'Copy.ai', discountBadge: '-15%' },
  { id: 'ai-14', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 10.20, label: 'Grammarly Premium', discountBadge: '-15%' },
  { id: 'ai-15', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.46, label: 'QuillBot Premium', discountBadge: '-15%' },
  { id: 'ai-16', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 11.04, label: 'Canva Pro', discountBadge: '-15%' },
  { id: 'ai-17', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.49, label: 'Adobe Firefly', discountBadge: '-15%' },
  { id: 'ai-18', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 10.20, label: 'Leonardo AI', discountBadge: '-15%' },
  { id: 'ai-19', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 16.99, label: 'Poe (Quora)', discountBadge: '-15%' },
  { id: 'ai-20', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 12.75, label: 'You.com Pro', discountBadge: '-15%' },
  { id: 'ai-21', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.49, label: 'Character.AI Plus', discountBadge: '-15%' },
  { id: 'ai-22', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 24.65, label: 'HeyGen', discountBadge: '-15%' },
  { id: 'ai-23', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 24.65, label: 'Synthesia', discountBadge: '-15%' },
  { id: 'ai-24', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 20.40, label: 'Descript', discountBadge: '-15%' },
  { id: 'ai-25', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 14.44, label: 'Otter.ai Pro', discountBadge: '-15%' },
  { id: 'ai-26', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.50, label: 'Fireflies.ai', discountBadge: '-15%' },
  { id: 'ai-27', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 17.00, label: 'Replit Core', discountBadge: '-15%' },
  { id: 'ai-28', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 10.20, label: 'Tabnine Pro', discountBadge: '-15%' },
  { id: 'ai-29', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 7.65, label: 'Codeium Pro', discountBadge: '-15%' },
  { id: 'ai-30', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 7.43, label: 'DeepL Pro', discountBadge: '-15%' },
  { id: 'ai-31', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 9.84, label: 'Speechify Premium', discountBadge: '-15%' },
  { id: 'ai-32', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 24.65, label: 'Murf.ai', discountBadge: '-15%' },
  { id: 'ai-33', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 16.15, label: 'Pictory', discountBadge: '-15%' },
  { id: 'ai-34', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 17.00, label: 'InVideo AI', discountBadge: '-15%' },
  { id: 'ai-35', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 10.20, label: 'Runway ML', discountBadge: '-15%' },
  { id: 'ai-36', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.50, label: 'Pika Labs', discountBadge: '-15%' },
  { id: 'ai-37', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 18.70, label: 'ElevenLabs', discountBadge: '-15%' },
  { id: 'ai-38', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.50, label: 'Suno AI', discountBadge: '-15%' },
  { id: 'ai-39', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.50, label: 'Udio', discountBadge: '-15%' },
  { id: 'ai-40', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.50, label: 'Kling AI', discountBadge: '-15%' },
  { id: 'ai-41', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.49, label: 'Luma Dream Machine', discountBadge: '-15%' },
  { id: 'ai-42', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 6.80, label: 'Ideogram', discountBadge: '-15%' },
  { id: 'ai-43', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.50, label: 'DreamStudio (Stable Diffusion)', discountBadge: '-15%' },
  { id: 'ai-44', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 12.74, label: 'Mistral Le Chat Pro', discountBadge: '-15%' },
  { id: 'ai-45', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 16.15, label: 'Writesonic', discountBadge: '-15%' },
  { id: 'ai-46', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 7.65, label: 'Rytr Premium', discountBadge: '-15%' },
  { id: 'ai-47', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 50.15, label: 'Surfer SEO AI', discountBadge: '-15%' },
  { id: 'ai-48', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 16.15, label: 'Semrush AI Copilot', discountBadge: '-15%' },
  { id: 'ai-49', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 10.20, label: 'Beautiful.ai', discountBadge: '-15%' },
  { id: 'ai-50', game: 'ai', amount: 1, unit: 'شهر', priceUSD: 8.50, label: 'Gamma AI', discountBadge: '-15%' },
];
...
export const INITIAL_POSTS: SocialPost[] = [
  {
    ...
    author: {
      ...
      verified: true,
      bio: 'تاجر حسابات وألعاب إلكترونية موثق | وكيل متجر بلس ميديا',
      followers: 8200,
      following: 120,
      balanceUSD: 50.00,
      ordersCount: 12,
  ...
  },
  {
    ...
    author: {
      ...
      verified: true,
      bio: 'الحساب الرسمي لمنصة متجر بلس ميديا للدعم والخدمات',
      followers: 45000,
      following: 10,
      balanceUSD: 9999,
      ordersCount: 999,
